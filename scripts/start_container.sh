...
docker run -d --name super-app-php \ -p 8080:80 \ mahmoudfiron/super-app-php:latest

# Node app listens on 3000 in the container → expose as 3000 outside
docker run -d --name super-app-node \ -p 3000:3000 \ mahmoudfiron/super-app-node:latest